\begin{titlepage}
    ...
    \textsc{\Large INF270}\\[0.5cm] % Major heading such as course name
    \textsc{\large Linear Programming}\\[0.5cm] % Minor heading such as course title

    \HRule \\[0.4cm]
    { \huge \bfseries Submission 1}\\[0.4cm] % Title of your document
    \HRule \\[1.5cm]
